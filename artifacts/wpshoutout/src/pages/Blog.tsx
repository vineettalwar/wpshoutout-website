...
const posts = [
  {
    ...
    excerpt: "How to extract compelling stories from developers without getting bogged down in code syntax.",
    date: "Oct 12, 2023",
    category: "Podcasting",
  ...
  },
  {
    ...
    excerpt: "What we've learned from attending 9 different WordCamps in 9 different countries in a single year.",
    date: "Sep 28, 2023",
    category: "Community",
  ...
  },
  {
    ...
    excerpt: "Our minimal viable setup for capturing studio-quality audio in noisy conference halls.",
    date: "Sep 15, 2023",
    category: "Gear",
  ...
  },
  {
    ...
    excerpt: "The ecosystem is huge, but the megaphone is often held by a few. It's time to democratize the mic.",
    date: "Aug 30, 2023",
    category: "Opinion",
      ...
      <div className="container px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {posts.map((post, i) => (
            ...
            >
              <Link href={`/blog/${post.id}`} className="relative aspect-[16/9] rounded-2xl overflow-hidden mb-6 block bg-card border border-border/50">
                <img 
                  src={post.img} 
                  alt={post.title}
